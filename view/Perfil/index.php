<?php
    ...
    <title>Perfil <?php echo $usuarios->nombreCompleto(); ?>| Soporte Técnico</title>
    </head>
    <body>
							...
							<div class="row">
								<div class="col-xl-9 col-xl-offset-3 col-lg-8 col-lg-offset-4 col-md-offset-0">
									<div class="tbl info-tbl">
										<div class="tbl-row">
											<div class="tbl-cell">
												<p class="title"><?php echo $usuarios->nombreCompleto(); ?></p>
												<p><?php echo $usuarios->getPuesto(); ?></p>
											</div>
				...
				<div class="col-xl-3 col-lg-4">
					<aside class="profile-side">
						<section class="box-typical profile-side-user">
							...
							<button type="button" class="btn btn-rounded">Mandar mensaje</button>
							<div class="bottom-txt">Rango: 154</div>
						</section>

						<section class="box-typical">
							<header class="box-typical-header-sm bordered">Sobre mí:</header>
							<div class="box-typical-inner">
								<p>Aquí va la descripción no mayor a 250 caracteres</p>
							</div>
						</section>
